...
#
# Keys are the "Type" value as reported by transceiver/DOM CLI output (lower-cased), e.g.
# "sfp+sr", "1000sx", "qsfp+sr4" - not just the bare form factor - since that's what
# actually distinguishes the connector in practice. Direct-attach copper (DAC/twinax,
# e.g. "sfp+da3") is handled separately in map_port_type() below rather than listed here,
# since the cable is permanently attached to the module and there's no separate connector
# to report.
#
...
INTERFACE_PORT_TYPE_MAP_STATIC = {
    "sfp+sr": "lc",
    "sfp+lr": "lc",
    "sfp+er": "lc",
    "sfp+zr": "lc",
