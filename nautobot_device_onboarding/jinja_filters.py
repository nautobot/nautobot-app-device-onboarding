...
def map_port_type(port_type):
    """Map a raw Aruba AOS-CX transceiver/port indicator to a Nautobot port_type (physical connector).
    ...
    if "da" in normalized:
        ...
        return ""
    return ARUBA_AOSCX_INTERFACE_PORT_TYPE_MAP_STATIC.get(normalized, "")
