...
class TestInventoryCreator(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.port = 22
        self.platform = Platform(name="cisco_c2960", network_driver="cisco_xe")
    ...
    def test_set_inventory_no_platform(self, mock_sshdetect):
        ...
        self.assertNotIn("nautobot_platform_name", inv["198.51.100.1"].data)
        self.assertIsNone(exception)

    def test_set_inventory_specified_platform_preserves_platform_name(self):
        ...
        self.assertEqual(inv["198.51.100.1"].data["nautobot_platform_name"], "cisco_c2960")
