...
class SSOTSyncNetworkDataTestCase(TransactionTestCase):
    ...
    def test_sync_network_devices_with_full_ssh(self):
        ...
        # Might take a few seconds for the SSH connection to initiate and to load
        for attempt in range(3):  # pylint: disable=unused-variable
            try:
        ...
        self.assertEqual(newly_imported_device.interfaces.last().name, "TenGigabitEthernet1/1/15")
